...
use Illuminate\Support\Facades\Storage; //kebutuhan update & edit data
...
class ProductController extends Controller
{
    ...
    public function create(): view{
        ...
        $data['categories_'] = $product->get_category_product()->get();
     ...
     */
     ...
     public function show(string $id): View{
      ...
      public function edit(string $id): View{
        ...
        $data['categories_'] = $product_model->get_category_product()->get();
